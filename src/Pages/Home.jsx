...
const WORDS = ["Welcome to H3", "Halal, Haram, Hantam."];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/0x03Nyenyee" },
  { icon: DiscordIcon, link: "https://discord.com/users/yrand." },
  { icon: Instagram, link: "https://www.instagram.com/nyenyee" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/bfb4d263-0249-478f-b630-507ef81ee00c/RWVYQPoy5v.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Skill: 10% Googling: 90% = Coding 100% Beres.
                </p>
